...
int main() {
    ...
    try {
        ...
        form = someRandomIntern.makeForm("I would like to request a Shrubbery Creation", "CoDam");
        static_cast<ShrubberyCreationForm *>(form)->execute(farmer);
	} catch (const std::exception &error) {
		std::cerr << "Error: " << error.what() << std::endl;
	}
    std::cout << std::endl;
     try {
        ...
        form = someRandomIntern.makeForm("Shrubbery Pardon Request", "CoDam");
	} catch (const std::exception &error) {
		std::cerr << "Error: " << error.what() << std::endl;
	}
    std::cout << std::endl;
     try {
        ...
        form = someRandomIntern.makeForm("A bunch of fucking bullshit", "CoDam");
	} catch (const std::exception &error) {
		std::cerr << "Error: " << error.what() << std::endl;
	}
}
